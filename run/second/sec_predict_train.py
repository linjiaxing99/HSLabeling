...
def predict_val():
    ...
    for batch_idx, batch in enumerate(tqdm(loader)):
        ...
        save_pred_anno(mask_clean, predict_val_path, filename, dict=potsdam_color_dict, flag=False)
...
def main():
    ...
    for batch_idx, batch in enumerate(tqdm(loader)):
        ...
        mask_clean = clean_mask(coarse_mask, cls_label)
        mask_clean = torch.argmax(mask_clean, dim=1)
        save_pred_anno(mask_clean, predict_train_path, filename, dict=potsdam_color_dict, flag=True)
