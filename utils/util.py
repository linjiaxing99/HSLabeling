...
def create_data_path(opt):
    ...
    train_txt_path = os.path.join(data_inform_path, 'seg_train_20000_HSLabeling_loveda.txt')
...
def get_mean_std(flag):
    if flag == 'potsdam':
        ...
        means = [136.40029509, 108.57168684, 108.14567309]
        std = [59.67618791, 59.00914154, 56.73830111]
    elif flag == 'loveda':
        means = [71.78568117, 78.44521898, 75.83672683]
        std = [35.895143, 32.96576701, 31.94201416]
