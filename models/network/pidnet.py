...
class PIDNet(nn.Module):
    ...
    def __init__(self, m=2, n=3, num_classes=19, planes=64, ppm_planes=96, head_planes=128, augment=False):
...
def get_seg_model(backbone, num_classes, imgnet_pretrained, pretrained_path):
